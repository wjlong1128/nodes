...
* sync queue - 半连接队列
  * 大小通过 /proc/sys/net/ipv 4/tcp_max_syn_backlog 指定，在 `syncookies` 启用的情况下，逻辑上没有最大值限制，这个设置便被忽略
* accept queue - 全连接队列
...
![image-20220416195214318](https://picgo-images0401.oss-cn-beijing.aliyuncs.com/picgo/image-20220416195214318.png)
...
<img src="https://picgo-images0401.oss-cn-beijing.aliyuncs.com/picgo/0032.png"  />
