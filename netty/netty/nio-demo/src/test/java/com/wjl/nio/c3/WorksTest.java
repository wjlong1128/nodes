...
public class WorksTest {
    ...
    public void server() throws IOException {
        ...
        // 创建固定数量的work
        TestWork[] testWorks = new TestWork[Runtime.getRuntime().availableProcessors()];
        for (int i = 0; i < testWorks.length; i++) {
            testWorks[i] = new TestWork("work-"+i);
        }
        //work0.init();
        ...
        while (true) {
            ...
            while (iterator.hasNext()) {
                ...
                if (key.isAcceptable()) {
                    ...
                    // 关联到 work线程的读事件
                    testWorks[ index.getAndIncrement() % testWorks.length ].init(accept);
