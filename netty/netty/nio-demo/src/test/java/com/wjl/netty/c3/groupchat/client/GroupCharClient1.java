package com.wjl.netty.c3.groupchat.client;
...
@Slf4j
public class GroupCharClient1 {
    public static final int SERVER_PORT = 8080;
    public static final String LOCALHOST = "localhost";
    public int port = SERVER_PORT;
    public String location = LOCALHOST;

    public GroupCharClient1() {
    }

    public GroupCharClient1(int port, String location) {
        this.port = port;
