...
@Slf4j
public class SafetyMessageCodec extends MessageToMessageCodec<ByteBuf, Message> {
    @Override
    ...
    public void test() throws Exception {
        ...
        encode(null,loginRequestMessage,new ArrayList<Object>());
