...
docker run -dit --name Myrabbitmq -e RABBITMQ_DEFAULT_USER=wjl -e RABBITMQ_DEFAULT_PASS=123456 -p 15672:15672 -p 5672:5672 rabbitmq:management
...
```sh
FXZMCVGLBIXZCDEMMVZQ # VXIVBCQUKZWUZXUHZABG
```
...
touch .erlang.cookie
# 写入cookie
echo "VXIVBCQUKZWUZXUHZABG" > .erlang.cookie
# 修改cookie文件的权限
