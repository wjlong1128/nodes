...
public class RouterFunctionMain {
	public static void main(String[] args) {
		AnnotationConfigServletWebServerApplicationContext context = new AnnotationConfigServletWebServerApplicationContext(RouterWebConfig.class);
        /*
        学到了什么
        函数式控制器
