...
public class ResourceHandlerMain {
	public static void main(String[] args) {
		AnnotationConfigServletWebServerApplicationContext context = new AnnotationConfigServletWebServerApplicationContext(ResourceWebConfig.class);
        /*
        学到了什么
        静态资源处理
