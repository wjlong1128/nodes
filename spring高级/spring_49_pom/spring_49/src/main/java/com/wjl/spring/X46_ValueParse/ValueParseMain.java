package com.wjl.spring.X46_ValueParse;
...
@Configuration
public class ValueParseMain {
	public static void main(String[] args) throws NoSuchFieldException, SecurityException {
		AnnotationConfigApplicationContext context = new AnnotationConfigApplicationContext(ValueParseMain.class);
...
//        test3(context, resolver, Bean2.class.getDeclaredField("bean3"));
	...
	private static void test3(AnnotationConfigApplicationContext context,
		...
		// 解析 #{} @bean3
		Object bean3 = context.getBeanFactory().getBeanExpressionResolver().evaluate(value,
